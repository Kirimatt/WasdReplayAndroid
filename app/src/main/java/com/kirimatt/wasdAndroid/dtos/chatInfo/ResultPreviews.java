...
public class ResultPreviews implements Serializable {
    ...
    public String toString() {
        return "Result{" +
                ...
                ", mediaContainerDescription='" + mediaContainerDescription + '\'' +
                ", mediaContainerType='" + mediaContainerType + '\'' +
                ", mediaContainerStatus='" + mediaContainerStatus + '\'' +
                ", mediaContainerOnlineStatus='" + mediaContainerOnlineStatus + '\'' +
                ", userId=" + userId +
                ", channelId=" + channelId +
                ", createdAt=" + createdAt +
                ...
                ", game=" + game +
                ", mediaContainerStreams=" + mediaContainerStreams +
                ", tags=" + tags +
                ", mediaContainerUser=" + mediaContainerUser +
                ", mediaContainerChannel=" + mediaContainerChannel +
                '}';
    }
}